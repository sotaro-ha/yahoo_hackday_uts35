 ...
 * @constructor
 */
export declare function Mixins<T extends Vue>(parent: VueClass<T>): VueClass<T>;
/**
 * Extend a Vue Component with mixins
 ...
 * @constructor
 */
export declare function Mixins<T extends Vue>(parent: VueClass<Vue>, ...mixins: VueClass<Vue>[]): VueClass<T>;
