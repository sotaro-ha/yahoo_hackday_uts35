<template>
  <div >
    ...
    <div class="main_background">
      <h2 class="title">日の丸弁当</h2>
      <p>このお弁当は、○□△コンビニのご飯です！</p>
      <div class="img_box"><img src="../assets/obentou_hinomaru.png" alt=""></div>
      <div class="price_box">
      <p class="price">300円</p>
      <div class="percent">10%引き！</div>
      </div>
      <p>消費期限が本日中なので、急いで食べてもらえると嬉しいです</p>
    <button class="buy_button">購入はこちら</button>
